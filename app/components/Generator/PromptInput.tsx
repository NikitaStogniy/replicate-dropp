...
export default function PromptInput({ value, onChange, onSubmit, maxLength = 500 }: PromptInputProps) {
  ...
  return (
    <div>
      <label className="block text-base sm:text-lg font-semibold text-gray-800 mb-2 sm:mb-3">Описание изображения</label>
      <div className="relative">
        <textarea
          ...
          className="w-full p-3 sm:p-4 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm sm:text-base text-gray-900 placeholder-gray-500 transition-colors resize-none bg-white/70 backdrop-blur-sm"
          rows={4}
          maxLength={maxLength}
        />
